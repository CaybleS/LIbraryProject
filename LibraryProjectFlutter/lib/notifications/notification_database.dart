...
void removeUserToken(String userToken, String userId) {
  dbReference.child('notifications/userTokens/$userId/$userToken/').remove();
}
...
Future<List<String>> getAllUserTokens(String userId) async {
  DatabaseEvent allUserTokens = await FirebaseDatabase.instance.ref('notifications/userTokens/$userId/').once();
