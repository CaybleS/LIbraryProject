...
import '../Futchers/CardBookShow.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: const Text("Add Book", style: TextStyle(fontSize: 16)),
          icon: const Icon(
            Icons.add,
            size: 20,
          ),
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      Widget image;
                      if (_userLibrary[_shownList[index]].imagePath != null) {
                        image = Image.asset(
                          _userLibrary[_shownList[index]].imagePath.toString(),
                          fit: BoxFit.fill,
                        );
                      } else {
                      ...
                      return InkWell(
                        onTap: () {
                          bookClicked(_shownList[index]);
                        },
                        child: const BookCard(
                            title: "Csharp Learning",
                            description: "This Is Best Csharp Book In 2022.",
                            status: "Available",
                            imageUrl: "assets/cover_2.jpeg"),
                        // child: Card(
